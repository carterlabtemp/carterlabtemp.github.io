...
![]({{ site.url }}{{ site.baseurl }}/images/research pic/ResearchPassengersVersusDrivers.png){: style="width: 550px; float: center; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/research pic/PublicationsInteractionsBetweenInheritedGenomeAndTumorDevelopment.png){: style="width: 550px; float: center; border: 10px"}
